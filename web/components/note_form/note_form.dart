...
import 'package:angular_forms/src/directives/ng_model.dart';
import 'package:angelangular/src/validators/validators.dart';

@Component(
    selector: 'note-form',
    templateUrl: 'note_form.html',
    directives: const [NgModel])
class NoteFormComponent implements OnDestroy {
  final StreamController<Note> _noteChange =
      new StreamController<Note>.broadcast();
