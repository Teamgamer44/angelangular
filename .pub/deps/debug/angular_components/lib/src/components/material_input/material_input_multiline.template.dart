...
import '../../utils/browser/dom_service/angular_2.template.dart' as _ref2;
import '../focus/focus.template.dart' as _ref3;
...
import 'package:angular_components/src/components/material_input/material_input_multiline.scss.css.shim.dart' as import1;
...
class ViewMaterialMultilineInputComponent0 extends DebugAppView<import10.MaterialMultilineInputComponent> {
  ...
  ViewMaterialMultilineInputComponent0(AppView<dynamic> parentView, num parentIndex) : super(import17.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialMultilineInputComponent0) {
    ...
    _renderType ??= import19.appViewUtils.createRenderType('package:angular_components/src/components/material_input/material_input_multiline.html', ViewEncapsulation.Emulated, styles$MaterialMultilineInputComponent);
