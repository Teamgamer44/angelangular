...
import '../../utils/browser/events/events.template.dart' as _ref1;
import '../../utils/color/color.template.dart' as _ref2;
import '../../utils/color/palette.template.dart' as _ref3;
import '../focus/keyboard_only_focus_indicator.template.dart' as _ref4;
...
import 'package:angular_components/src/components/scorecard/scorecard.scss.css.shim.dart' as import0;
...
class ViewScorecardComponent0 extends DebugAppView<import5.ScorecardComponent> {
  ...
  ViewScorecardComponent0(AppView<dynamic> parentView, num parentIndex) : super(import10.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_ScorecardComponent0) {
    ...
    _renderType ??= import12.appViewUtils.createRenderType('package:angular_components/src/components/scorecard/scorecard.html', ViewEncapsulation.Emulated, styles$ScorecardComponent);
