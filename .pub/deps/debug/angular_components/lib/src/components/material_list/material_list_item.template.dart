...
import '../button_decorator/button_decorator.template.dart' as _ref3;
import '../mixins/material_dropdown_base.template.dart' as _ref4;
import 'package:angular/angular.template.dart' as _ref5;

import 'package:angular_components/src/components/material_list/material_list_item.scss.css.shim.dart' as import0;
...
class ViewMaterialListItemComponent0 extends DebugAppView<import3.MaterialListItemComponent> {
  ...
  ViewMaterialListItemComponent0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialListItemComponent0) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType('asset:angular_components/lib/src/components/material_list/material_list_item.dart class MaterialListItemComponent - inline template', ViewEncapsulation.Emulated, styles$MaterialListItemComponent);
