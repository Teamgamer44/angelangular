...
import '../../model/ui/accepts_width.template.dart' as _ref0;
import '../../utils/angular/properties/properties.template.dart' as _ref1;
import 'material_list_size.template.dart' as _ref2;
import 'material_list_size.template.dart' as _ref3;
import 'package:angular/angular.template.dart' as _ref4;

import 'package:angular_components/src/components/material_list/material_list.scss.css.shim.dart' as import0;
...
class ViewMaterialListComponent0 extends DebugAppView<import3.MaterialListComponent> {
  ...
  ViewMaterialListComponent0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialListComponent0) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType('asset:angular_components/lib/src/components/material_list/material_list.dart class MaterialListComponent - inline template', ViewEncapsulation.Emulated, styles$MaterialListComponent);
