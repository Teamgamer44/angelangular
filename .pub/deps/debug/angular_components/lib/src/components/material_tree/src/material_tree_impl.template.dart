...
import './material_tree_root.template.dart' as _ref5;
import 'group/material_tree_group.template.dart' as _ref6;
import 'group/material_tree_group_flat.template.dart' as _ref7;
...
class ViewMaterialTreeComponent0 extends DebugAppView<import4.MaterialTreeComponent> {
  ...
  ViewMaterialTreeComponent0(AppView<dynamic> parentView, num parentIndex) : super(import9.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways, nodeDebugInfos_MaterialTreeComponent0) {
    ...
    _renderType ??= import12.appViewUtils.createRenderType('package:angular_components/src/components/material_tree/src/material_tree_impl.html', ViewEncapsulation.None, styles$MaterialTreeComponent);
