...
import '../material_input/material_input.template.dart' as _ref4;
import '../mixins/focusable_mixin.template.dart' as _ref5;
import 'package:angular/angular.template.dart' as _ref6;
import 'package:angular_forms/angular_forms.template.dart' as _ref7;

import 'package:angular_components/src/components/material_select/material_select_searchbox.scss.css.shim.dart' as import0;
...
class ViewMaterialSelectSearchboxComponent0 extends DebugAppView<import11.MaterialSelectSearchboxComponent> {
  ...
  ViewMaterialSelectSearchboxComponent0(AppView<dynamic> parentView, num parentIndex) : super(import18.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways, nodeDebugInfos_MaterialSelectSearchboxComponent0) {
    ...
    _renderType ??= import20.appViewUtils.createRenderType('package:angular_components/src/components/material_select/material_select_searchbox.html', ViewEncapsulation.Emulated, styles$MaterialSelectSearchboxComponent);
