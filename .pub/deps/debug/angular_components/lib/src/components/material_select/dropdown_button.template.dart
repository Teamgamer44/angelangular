...
import '../focus/keyboard_only_focus_indicator.template.dart' as _ref1;
import '../glyph/glyph.template.dart' as _ref2;
import '../mixins/button_wrapper.template.dart' as _ref3;
import 'package:angular/angular.template.dart' as _ref4;

import 'package:angular_components/src/components/button_decorator/button_decorator.scss.css.shim.dart' as import0;
import 'package:angular_components/src/components/material_select/dropdown_button.scss.css.shim.dart' as import1;
...
class ViewDropdownButtonComponent0 extends DebugAppView<import8.DropdownButtonComponent> {
  ...
  ViewDropdownButtonComponent0(AppView<dynamic> parentView, num parentIndex) : super(import15.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_DropdownButtonComponent0) {
    ...
    _renderType ??= import17.appViewUtils.createRenderType('package:angular_components/src/components/material_select/dropdown_button.html', ViewEncapsulation.Emulated, styles$DropdownButtonComponent);
