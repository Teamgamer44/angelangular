...
import 'package:angular_components/src/components/material_tab/material_tab_panel.scss.css.shim.dart' as import0;
...
class ViewMaterialTabPanelComponent0 extends DebugAppView<import4.MaterialTabPanelComponent> {
  ...
  ViewMaterialTabPanelComponent0(AppView<dynamic> parentView, num parentIndex) : super(import9.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialTabPanelComponent0) {
    ...
    _renderType ??= import11.appViewUtils.createRenderType('package:angular_components/src/components/material_tab/material_tab_panel.html', ViewEncapsulation.Emulated, styles$MaterialTabPanelComponent);
