...
import '../focus/focus_item.template.dart' as _ref1;
import '../focus/focus_list.template.dart' as _ref2;
...
import 'package:angular_components/src/components/material_tab/fixed_material_tab_strip.scss.css.shim.dart' as import0;
...
class ViewFixedMaterialTabStripComponent0 extends DebugAppView<import6.FixedMaterialTabStripComponent> {
  ...
  ViewFixedMaterialTabStripComponent0(AppView<dynamic> parentView, num parentIndex) : super(import13.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_FixedMaterialTabStripComponent0) {
    ...
    _renderType ??= import15.appViewUtils.createRenderType('package:angular_components/src/components/material_tab/fixed_material_tab_strip.html', ViewEncapsulation.Emulated, styles$FixedMaterialTabStripComponent);
