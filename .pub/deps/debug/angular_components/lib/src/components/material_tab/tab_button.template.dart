...
import '../material_button/material_button_base.template.dart' as _ref0;
import '../material_ripple/material_ripple.template.dart' as _ref1;
import './tab_mixin.template.dart' as _ref2;
import 'package:angular/angular.template.dart' as _ref3;

import 'package:angular_components/src/components/material_tab/tab_button.scss.css.shim.dart' as import0;
...
class ViewTabButtonComponent0 extends DebugAppView<import4.TabButtonComponent> {
  ...
  ViewTabButtonComponent0(AppView<dynamic> parentView, num parentIndex) : super(import9.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways, nodeDebugInfos_TabButtonComponent0) {
    ...
    _renderType ??= import11.appViewUtils.createRenderType('asset:angular_components/lib/src/components/material_tab/tab_button.dart class TabButtonComponent - inline template', ViewEncapsulation.Emulated, styles$TabButtonComponent);
