...
import '../../utils/id_generator/id_generator.template.dart' as _ref0;
import '../content/deferred_content_aware.template.dart' as _ref1;
import '../focus/focus.template.dart' as _ref2;
import 'package:angular/angular.template.dart' as _ref3;

import 'package:angular_components/src/components/material_tab/material_tab.scss.css.shim.dart' as import0;
...
class ViewMaterialTabComponent0 extends DebugAppView<import5.MaterialTabComponent> {
  ...
  ViewMaterialTabComponent0(AppView<dynamic> parentView, num parentIndex) : super(import9.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways, nodeDebugInfos_MaterialTabComponent0) {
    ...
    _renderType ??= import12.appViewUtils.createRenderType('asset:angular_components/lib/src/components/material_tab/material_tab.dart class MaterialTabComponent - inline template', ViewEncapsulation.Emulated, styles$MaterialTabComponent);
