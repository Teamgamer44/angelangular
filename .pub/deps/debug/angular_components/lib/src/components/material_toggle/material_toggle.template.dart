...
import 'package:angular_components/src/components/material_toggle/material_toggle.scss.css.shim.dart' as import0;
...
class ViewMaterialToggleComponent0 extends DebugAppView<import5.MaterialToggleComponent> {
  ...
  ViewMaterialToggleComponent0(AppView<dynamic> parentView, num parentIndex) : super(import10.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialToggleComponent0) {
    ...
    _renderType ??= import12.appViewUtils.createRenderType('package:angular_components/src/components/material_toggle/material_toggle.html', ViewEncapsulation.Emulated, styles$MaterialToggleComponent);
