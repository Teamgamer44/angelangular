...
import '../../utils/browser/feature_detector/feature_detector.template.dart' as _ref1;
import '../../utils/color/material.template.dart' as _ref2;
import 'package:angular/angular.template.dart' as _ref3;

import 'package:angular_components/src/components/material_ripple/material_ripple.scss.css.dart' as import0;
...
class ViewMaterialRippleComponent0 extends DebugAppView<import3.MaterialRippleComponent> {
  ...
  ViewMaterialRippleComponent0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialRippleComponent0) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType('asset:angular_components/lib/src/components/material_ripple/material_ripple.dart class MaterialRippleComponent - inline template', ViewEncapsulation.None, styles$MaterialRippleComponent);
