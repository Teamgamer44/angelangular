...
import 'material_drawer_base.template.dart' as _ref1;
import 'package:angular/angular.template.dart' as _ref2;

import 'package:angular_components/src/components/app_layout/material_temporary_drawer.scss.css.shim.dart' as import0;
...
class ViewMaterialTemporaryDrawerComponent0 extends DebugAppView<import3.MaterialTemporaryDrawerComponent> {
  ...
  ViewMaterialTemporaryDrawerComponent0(AppView<dynamic> parentView, num parentIndex) : super(import7.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialTemporaryDrawerComponent0) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType('package:angular_components/src/components/app_layout/material_temporary_drawer.html', ViewEncapsulation.Emulated, styles$MaterialTemporaryDrawerComponent);
