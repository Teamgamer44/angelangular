...
import 'package:angular_components/src/components/material_icon/material_icon.scss.css.shim.dart' as import0;
...
class ViewMaterialIconComponent0 extends DebugAppView<import3.MaterialIconComponent> {
  ...
  ViewMaterialIconComponent0(AppView<dynamic> parentView, num parentIndex) : super(import7.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialIconComponent0) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType('package:angular_components/src/components/material_icon/material_icon.html', ViewEncapsulation.Emulated, styles$MaterialIconComponent);
