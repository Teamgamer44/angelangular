...
import '../../utils/disposer/disposer.template.dart' as _ref0;
import '../../utils/keyboard/keyboard.template.dart' as _ref1;
import './reorder_events.template.dart' as _ref2;
import 'package:angular/angular.template.dart' as _ref3;
import 'reorder_events.template.dart' as _ref4;

import 'package:angular_components/src/components/reorder_list/reorder_list.scss.css.shim.dart' as import0;
...
class ViewReorderListComponent0 extends DebugAppView<import3.ReorderListComponent> {
  ...
  ViewReorderListComponent0(AppView<dynamic> parentView, num parentIndex) : super(import8.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways, nodeDebugInfos_ReorderListComponent0) {
    ...
    _renderType ??= import10.appViewUtils.createRenderType('package:angular_components/src/components/reorder_list/reorder_list.html', ViewEncapsulation.Emulated, styles$ReorderListComponent);
