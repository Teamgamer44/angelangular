...
import './material_chip.template.dart' as _ref3;
import 'package:angular/angular.template.dart' as _ref4;

import 'package:angular_components/src/components/material_chips/material_chips.scss.css.shim.dart' as import0;
...
class ViewMaterialChipsComponent0 extends DebugAppView<import5.MaterialChipsComponent> {
  ...
  ViewMaterialChipsComponent0(AppView<dynamic> parentView, num parentIndex) : super(import9.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialChipsComponent0) {
    ...
    _renderType ??= import12.appViewUtils.createRenderType('package:angular_components/src/components/material_chips/material_chips.html', ViewEncapsulation.Emulated, styles$MaterialChipsComponent);
