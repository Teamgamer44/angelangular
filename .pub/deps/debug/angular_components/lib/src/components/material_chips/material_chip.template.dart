...
import '../../utils/id_generator/id_generator.template.dart' as _ref2;
...
import 'package:angular_components/src/components/material_chips/material_chip.scss.css.shim.dart' as import0;
...
class ViewMaterialChipComponent0 extends DebugAppView<import5.MaterialChipComponent> {
  ...
  ViewMaterialChipComponent0(AppView<dynamic> parentView, num parentIndex) : super(import10.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialChipComponent0) {
    ...
    _renderType ??= import12.appViewUtils.createRenderType('package:angular_components/src/components/material_chips/material_chip.html', ViewEncapsulation.Emulated, styles$MaterialChipComponent);
