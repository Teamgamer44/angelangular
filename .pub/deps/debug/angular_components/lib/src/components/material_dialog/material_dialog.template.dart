...
import '../../laminate/components/modal/modal.template.dart' as _ref0;
import '../../utils/browser/dom_service/dom_service.template.dart' as _ref1;
import '../../utils/disposer/disposer.template.dart' as _ref2;
import '../focus/focus_trap.template.dart' as _ref3;
import 'package:angular/angular.template.dart' as _ref4;

import 'package:angular_components/src/components/material_dialog/material_dialog.scss.css.shim.dart' as import0;
...
class ViewMaterialDialogComponent0 extends DebugAppView<import6.MaterialDialogComponent> {
  ...
  ViewMaterialDialogComponent0(AppView<dynamic> parentView, num parentIndex) : super(import13.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialDialogComponent0) {
    ...
    _renderType ??= import15.appViewUtils.createRenderType('package:angular_components/src/components/material_dialog/material_dialog.html', ViewEncapsulation.Emulated, styles$MaterialDialogComponent);
