...
import 'package:angular_components/src/components/material_spinner/material_spinner.scss.css.shim.dart' as import0;
...
class ViewMaterialSpinnerComponent0 extends DebugAppView<import3.MaterialSpinnerComponent> {
  ...
  ViewMaterialSpinnerComponent0(AppView<dynamic> parentView, num parentIndex) : super(import7.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialSpinnerComponent0) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType('package:angular_components/src/components/material_spinner/material_spinner.html', ViewEncapsulation.Emulated, styles$MaterialSpinnerComponent);
