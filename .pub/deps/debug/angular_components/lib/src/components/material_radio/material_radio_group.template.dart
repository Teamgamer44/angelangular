...
import '../../utils/disposer/disposer.template.dart' as _ref2;
import '../focus/focus.template.dart' as _ref3;
import './material_radio.template.dart' as _ref4;
import 'package:angular/angular.template.dart' as _ref5;
import 'package:angular_forms/angular_forms.template.dart' as _ref6;

import 'package:angular_components/src/components/material_radio/material_radio_group.scss.css.shim.dart' as import0;
...
class ViewMaterialRadioGroupComponent0 extends DebugAppView<import3.MaterialRadioGroupComponent> {
  ...
  ViewMaterialRadioGroupComponent0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialRadioGroupComponent0) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType('asset:angular_components/lib/src/components/material_radio/material_radio_group.dart class MaterialRadioGroupComponent - inline template', ViewEncapsulation.Emulated, styles$MaterialRadioGroupComponent);
