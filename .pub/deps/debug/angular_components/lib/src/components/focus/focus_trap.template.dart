...
import '../../utils/browser/dom_iterator/dom_iterator.template.dart' as _ref0;
...
import 'package:angular_components/src/components/focus/focus_trap.scss.css.shim.dart' as import0;
...
class ViewFocusTrapComponent0 extends DebugAppView<import2.FocusTrapComponent> {
  ...
  ViewFocusTrapComponent0(AppView<dynamic> parentView, num parentIndex) : super(import8.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_FocusTrapComponent0) {
    ...
    _renderType ??= import10.appViewUtils.createRenderType('package:angular_components/src/components/focus/focus_trap.html', ViewEncapsulation.Emulated, styles$FocusTrapComponent);
