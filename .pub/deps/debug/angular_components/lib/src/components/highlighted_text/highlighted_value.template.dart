...
import '../../model/ui/has_renderer.template.dart' as _ref0;
import '../../model/ui/highlight_provider.template.dart' as _ref1;
import '../../model/ui/highlighted_text_model.template.dart' as _ref2;
import './highlighted_text.template.dart' as _ref3;
import 'package:angular/angular.template.dart' as _ref4;

import 'package:angular_components/src/components/highlighted_text/highlighted_text.scss.css.shim.dart' as import0;
...
class ViewHighlightedValueComponent0 extends DebugAppView<import5.HighlightedValueComponent> {
  ...
  ViewHighlightedValueComponent0(AppView<dynamic> parentView, num parentIndex) : super(import9.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways, nodeDebugInfos_HighlightedValueComponent0) {
    ...
    _renderType ??= import12.appViewUtils.createRenderType('package:angular_components/src/components/highlighted_text/highlighted_text.html', ViewEncapsulation.Emulated, styles$HighlightedValueComponent);
