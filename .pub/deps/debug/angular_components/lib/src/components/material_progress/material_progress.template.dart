...
import '../../utils/browser/feature_detector/feature_detector.template.dart' as _ref0;
import 'package:angular/angular.template.dart' as _ref1;

import 'package:angular_components/src/components/material_progress/material_progress.scss.css.shim.dart' as import0;
...
class ViewMaterialProgressComponent0 extends DebugAppView<import3.MaterialProgressComponent> {
  ...
  ViewMaterialProgressComponent0(AppView<dynamic> parentView, num parentIndex) : super(import8.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce, nodeDebugInfos_MaterialProgressComponent0) {
    ...
    _renderType ??= import10.appViewUtils.createRenderType('package:angular_components/src/components/material_progress/material_progress.html', ViewEncapsulation.Emulated, styles$MaterialProgressComponent);
