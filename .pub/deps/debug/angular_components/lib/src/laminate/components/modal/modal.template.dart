...
import '../../../components/content/deferred_content_aware.template.dart' as _ref0;
import '../../../model/action/async_action.template.dart' as _ref1;
import '../../../utils/disposer/disposer.template.dart' as _ref2;
import '../../overlay/overlay.template.dart' as _ref3;
import 'package:angular/angular.template.dart' as _ref4;
import 'src/modal_controller_directive.template.dart' as _ref5;
...
class ViewModalComponent0 extends DebugAppView<import4.ModalComponent> {
  ...
  ViewModalComponent0(AppView<dynamic> parentView, num parentIndex) : super(import8.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways, nodeDebugInfos_ModalComponent0) {
    ...
    _renderType ??= import11.appViewUtils.createRenderType('asset:angular_components/lib/src/laminate/components/modal/modal.dart class ModalComponent - inline template', ViewEncapsulation.None, styles$ModalComponent);
